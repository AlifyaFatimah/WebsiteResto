		...
		<div class=”container mb-5”>
			<div class="row">
				...
				<div class="col-6 col-md-4" style='margin-left:100px'>
					...
					<form method="POST" action="/hapus">
						...
						<div class="daftar menu">
							<input type="checkbox" id="{{$menu->id}}" name="menuid[]" value="{{$menu->id}}" style="float:left;margin-top:35px;margin-bottom:35px;margin-right:15px;"/>
				...
				<center style="margin:20px">
					<button class="btn btn-success btn-md"><a href="{{URL::to('/regis3')}}" style="color:white;text-decoration: none">Simpan dan Lanjut</a></button>
				</center>
			</div>
		</div>
	</div>
