  ...
  <main>
    ...
    <div class="container m-4" style="overflow: auto;">
      <ul class="nav nav-tabs justify-content-center nav-fill" id="myTab">
        ...
        <li class="nav-item">
          <a href="{{URL::to('/Transaksi-masuk')}}" class="nav-link">Transaksi Masuk</a>
        </li>
      ...
      <div class="tab-pane" id="berlangsung">
        ...
        <div class="card-content">
          @foreach ($current as $transaksi)
          <div class="card p-4 m-2">
            <p class="text-xs text-semi mb-1">IDORDER : {{$transaksi->idReservasi}}</p>
            <p class="text-2xs mb-3" style="color: #727472">{{$transaksi->created_at}}</p>
            ...
            <p class="text-2xs mb-1" style="color: #727472">Tanggal Reservasi : {{$transaksi->date_reservasi}}</p>
            <p class="text-2xs mb-1" style="color: #727472">Waktu Reservasi : {{$transaksi->time_reservasi}}</p>
            <p class="text-2xs mb-4" style="color: #727472">No Meja : {{$transaksi->no_table}}</p>
            <a type="button" class="btn btn-primary" style="width: 10%" href="/Selesai/{{$transaksi->idReservasi}}" onclick="return confirm('Selesaikan pesanan?')">Selesai</a>
